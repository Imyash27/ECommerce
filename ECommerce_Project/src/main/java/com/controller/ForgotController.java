	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("submit"))
		{
			...
			else
			{
				...
				final String Senderid = "yashkanzariya50@gmail.com";
				final String password = "roiqlhxjggddmots";
				...
				try {
					...
					String msg1 = "<!DOCTYPE html><html><head></head><body>"
							+ "<center><div style='background-color:#f8f8f8; width:500px; height:200px'>"
							+ "<div style='background-color:#00e58b; width:500px; height:50px'>"
							+ "<h3 style='color:white; padding-top:10px;'>Email Validate Demo</h3>"
							+ "</div> <p style='color:gray; margin-left:-300px;'>Dear "
							+ username + ",</p><br><p style='color:gray; margin-top:-10px;'>" + otp
							+ "  is your One Time Password.Do NOT share this code with anyone for security reasons.this is valid for 10 minutes.</p><div>"
							+ "</center></body></html>";
